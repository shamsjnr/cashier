        ...
        <AppLayout>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4 print:px-1 print:py-2 max-w-4xl 2xl:max-w-7xl">
                <div className="flex justify-end items-center print:hidden">
                    <Link className='flex items-center gap-2 px-3 py-2 bg-green-700 text-gray-100 rounded-lg' href={route('receipt.list')} prefetch={'hover'}>
                            ...
                            <table className='w-full'>
                                <thead>
                                    <tr className=''>
                                        ...
                                        <th className='text-end py-2 px-2'>Printed at</th>
                                        <th className='text-end py-2 px-3'>By</th>
                                ...
                                receipts?.map((data: Receipt, i: number) => (
                                    <tr key={`receipts-${i}`} className='print:border-gray-500 border-t'>
                                        ...
                                        <td className='!px-3 py-2.5 print:py-2'>{ data.user }</td>
